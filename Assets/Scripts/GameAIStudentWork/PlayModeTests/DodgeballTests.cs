...
namespace Tests
{
    ...
    public class DodgeballTests
    {
        ...
        public IEnumerator CheckNameForHW5AndHW6()
        {
            ...
            CheckName(GameAIStudent.MinionStateMachine.StudentName, "HW6 - MinionStateMachine");
        ...
        public IEnumerator TestShootingRange()
        {
            ...
            var waitForInit = new WaitForSeconds(1f);
            ...
            srange.INTERNAL_AddAimMethod(new ShootingRange.AimMethod(GameAIStudent.ThrowMethods.StudentName,
            ...
            srange.INTERNAL_setEnforceSpeedLimit(true);
            ...
            Debug.Log($"PredictThrow() runtime: avg: {srange.RuntimeAvgDuration}, min: {srange.RuntimeMinDuration}, max: {srange.RuntimeMaxDuration}");
        }
